...
#### 2. Динамични mock бюджети (ОБНОВЕНО) ✅
- Mock бюджетите сега автоматично използват **месеца на регистрация** на потребителя
- Винаги актуални дати (например 01.01.2026 - 31.01.2026 за регистрация през Януари)
- По-логично поведение - бюджетите покриват целия месец на регистрация
