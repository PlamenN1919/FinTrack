            ...
            <View style={styles.progressContainer}>
              ...
              <View style={styles.percentageRow}>
                ...
                <Text style={[styles.remaining, { color: remaining >= 0 ? theme.colors.success : theme.colors.error }]}>
                  {remaining >= 0 ? `${remaining.toFixed(2)} € остават` : `Превишен с ${Math.abs(remaining).toFixed(2)} €`}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.analysisItem}>
              ...
              <View style={styles.analysisContent}>
                ...
                <Text style={[styles.analysisValue, { color: theme.colors.text }]}>
                  {getAverageTransactionAmount().toFixed(2)} €
                </Text>
              </View>
            </View>
              ...
              <View style={styles.analysisContent}>
                ...
                <Text style={[styles.analysisValue, { color: theme.colors.text }]}>
                  {currentMonthTransactions.length > 0 
                    ? Math.abs(Math.min(...currentMonthTransactions.map(t => t.amount))).toFixed(2) + ' €'
                    : '0.00 €'
                  }
                </Text>
              </View>
