    ...
    try {
      ...
      const checkNavigation = () => {
        ...
        if (retryCount < maxRetries) {
          ...
          Alert.alert(
            'Плащането е успешно!',
            'Вашият абонамент е активиран. Изберете как да продължите:',
            [
              {
                text: 'Обнови състоянието',
                onPress: () => {
      ...
      Alert.alert(
        'Плащането е успешно!',
        'Вашият абонамент е активиран. Моля, рестартирайте приложението.',
        [
          { 
            text: 'Добре',
