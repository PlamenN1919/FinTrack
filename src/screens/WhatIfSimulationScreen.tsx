...
const WhatIfSimulationScreen: React.FC = () => {
  ...
  const predefinedScenarios: SimulationScenario[] = [
    ...
    },
    {
      ...
      description: 'Какво ако спестявам 300 € всеки месец?',
      icon: '🐖',
      type: 'savings',
      parameters: {
        amount: 300,
    ...
    },
    {
      ...
      description: 'Какво ако инвестирам 500 € месечно с 5% доходност?',
      icon: '📈',
      type: 'investment',
      parameters: {
        amount: 500,
    ...
    },
    {
      ...
      description: 'Какво ако взема заем от 5000 € за 24 месеца?',
      icon: '💳',
      type: 'debt',
      parameters: {
        amount: -5000,
    ...
    },
    {
      ...
      description: 'Какво ако започна странична дейност за 200 € месечно?',
      icon: '💼',
      type: 'income',
      parameters: {
        amount: 200,
    ...
    switch (scenario.type) {
      ...
      case 'savings':
        ...
        break;
         ...
         recommendations.push(`Очаквана стойност след ${investmentMonths} месеца: ${futureValue.toFixed(2)} €`);
         if (riskLevel === 'high') {
       ...
       case 'debt':
        ...
        recommendations.push(`Месечна вноска: ${monthlyPayment.toFixed(2)} €`);
        if (riskLevel === 'high') {
      ...
      <View style={styles.resultMetrics}>
        <View style={styles.metricItem}>
          ...
          <Text style={[
            ...
            {result.monthlyImpact >= 0 ? '+' : ''}{result.monthlyImpact.toFixed(2)} €
          </Text>
        </View>
        ...
        <View style={styles.metricItem}>
          ...
          <Text style={[
            ...
            {result.yearlyImpact >= 0 ? '+' : ''}{result.yearlyImpact.toFixed(2)} €
          </Text>
        </View>
      </View>
